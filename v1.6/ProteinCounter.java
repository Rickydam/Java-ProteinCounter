...
public class ProteinCounter extends JFrame implements ActionListener
{
    ...
    public ProteinCounter()       
    {
        ...
        frame.setPreferredSize(new Dimension(1983, 1180)); // (width, length)      
    ...
    private void custom()
    {
        ...
        custom_1.setFont(new Font(null, Font.BOLD, 50));
        custom_1.setHorizontalAlignment(JLabel.CENTER);
              
        customFoodName = new JTextField(9); // (width)
        customFoodName.setEditable(true); 
        customFoodName.setFont(new Font(null, 0, 70));
        ...
        custom_2.setFont(new Font(null, Font.BOLD, 50));
        custom_2.setHorizontalAlignment(JLabel.CENTER);       
        
        customFoodValue = new JTextField(9); // (width)
        customFoodValue.setEditable(true); 
        customFoodValue.setFont(new Font(null, 0, 70));
